...
function Update(){
  ...
  else if (idleTimer >= 6 && idleTimer < 20 && (cam1.enabled == true || cam3.enabled == true)) {
    cam1.enabled = false;
    cam2.enabled = true;
    cam3.enabled = false;
    cam4.enabled = false;
  ...
  else if (idleTimer >= 20 && idleTimer < 36 && (cam2.enabled == true || cam1.enabled == true)) {
  ...
  else if (idleTimer >= 36 && idleTimer < 51 && (cam2.enabled == true || cam3.enabled == true)) {
  ...
  else if (idleTimer >= 51 && idleTimer < 61 && (cam3.enabled == true || cam4.enabled == true)) {
 ...
 else if (idleTimer >= 61 && idleTimer < 73 && (cam4.enabled == true || cam5.enabled == true)) {
  ...
  else if (idleTimer >= 73 && (cam5.enabled == true || cam6.enabled == true)){
  	idleTimer = 6;
    cam1.enabled = false;
    cam2.enabled = true;
    cam3.enabled = false;
